...
namespace Sistem_Informasi_Perusahaan
{
    ...
    {
        int pegawai_id;
        public frmAddEditStaff(int no_id)
        {
        ...
        protected override void WndProc(ref Message frmAddEditStaff)
        {
            switch (frmAddEditStaff.Msg)
            {
                case 0x84:
                    base.WndProc(ref frmAddEditStaff);
                    if ((int)frmAddEditStaff.Result == 0x1)
                        frmAddEditStaff.Result = (IntPtr)0x2;
                    return;
            }
