...
namespace Sistem_Informasi_Perusahaan
{
    public partial class frmDatabaseConfig : Form
    {
        ...
        protected override void WndProc(ref Message frmDatabaseConfig)
        {
            switch (frmDatabaseConfig.Msg)
            {
                case 0x84:
                    base.WndProc(ref frmDatabaseConfig);
                    if ((int)frmDatabaseConfig.Result == 0x1)
                        frmDatabaseConfig.Result = (IntPtr)0x2;
                    return;
            }
